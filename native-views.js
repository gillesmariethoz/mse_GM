(() => {
  ...
  style.textContent += '.native-stat,.native-module{background:var(--card)}@media(max-width:1100px){.native-week{grid-template-columns:repeat(4,minmax(0,1fr))}}@media(max-width:650px){.native-week{grid-template-columns:repeat(2,minmax(0,1fr))}}';
